...
function [T, y, X_test, y_test] = load_SONAR(normalization_range)
    ...
    % Import the data
    data = readtable('C:/Users/User/Desktop/svm_posit-main/datasets/sonar_train.csv', opts);

    % Normalization
    rng default;

    data(:,1:60) = normalize(data(:,1:60), 'range', normalization_range);
    writetable(data, 'C:/Users/User/Desktop/svm_posit-main/datasets/sonar_train_normalized.csv', 'Delimiter', ',', 'WriteVariableNames', false);
    ...
    %% Test set
    % Import the data
    test = readtable('C:/Users/User/Desktop/svm_posit-main/datasets/sonar_test.csv', opts);

    % Normalization
    rng default;

    test(:,1:60) = normalize(test(:,1:60), 'range', normalization_range);
    writetable(test, 'C:/Users/User/Desktop/svm_posit-main/datasets/sonar_test_normalized.csv', 'Delimiter', ',', 'WriteVariableNames', false);
